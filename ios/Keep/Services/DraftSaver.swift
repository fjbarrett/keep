...
final class DraftSaver {
    ...
    func stage(id: String, body: String, base: Note?, title: String? = nil, color: String? = nil) {
                ...
                do {
                    ...
                    do {
                        if let base = draft.base {
                            ...
                            if draft.color != nil { patch["color"] = draft.resolvedColor ?? NSNull() }
                            if draft.title != nil {
                            ...
                            saved = try await api.create(body: draft.body, title: draft.resolvedTitle,
                                                         id: id, ownerID: owner, color: draft.resolvedColor)
                        }
                    ...
                    if case APIError.conflict(let remote) = error {
                        ...
                        if remote.body == draft.base?.body,
                           ...
                           draft.color == nil || remote.color == draft.base?.color || remote.color == draft.resolvedColor,
    ...
    func saveCopy(_ id: String) -> String? {
        ...
        let copy = NoteDraft(id: UUID().uuidString.replacingOccurrences(of: "-", with: "").lowercased(),
                             body: draft.body, title: draft.title, color: draft.color ?? draft.base?.color)
        do {
